        ...
        while True:
            ...
            if results.pose_landmarks:
                ...
                if workout_name == "lunge":
                    feedback, reps_count = check_lunge_form(frame, landmarks, state)
                elif workout_name == "press":
                    feedback, reps_count = check_overhead_press_form(frame, landmarks, state)
                elif workout_name == "plank":
                    feedback, reps_count = check_plank_form(frame, landmarks, state)
